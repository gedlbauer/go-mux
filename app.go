...
func (a *App) getAvgPrice(w http.ResponseWriter, r *http.Request) {
	avg, err := getAvgPrice(a.DB)
	if err != nil {
		switch err {
		case sql.ErrNoRows:
			respondWithError(w, http.StatusNotFound, "Product not found")
...
func (a *App) initializeRoutes() {
	...
	a.Router.HandleFunc("/products/averagePrice", a.getAvgPrice).Methods("GET")
